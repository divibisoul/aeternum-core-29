...
const expected = ['N01', 'N02', 'N03', 'N04', 'N05', 'N06', 'N07'];
...
if (manifest.system !== 'SOUL' || manifest.fusionVersion !== '1.5' || manifest.nucleus !== 'N01') throw new Error('INVALID_N01_FUSION_MANIFEST');
