...
async function proxy(req, res) {
  ...
  if (req.method === 'POST' && req.url === '/api/soul-mesh') {
    try {
      ...
      if (message?.protocol === 'soul-mesh/1' && message.source === 'N07' && message.target === 'N01') {
        if (message.contractVersion !== '1.1.0' || !message.id || !message.correlationId || !['response', 'error'].includes(message.kind)) {
          writeDirect(res, 400, {
