              ...
              <CardContent className="p-2 space-y-1">
                ...
                {metrics?.deviceStatus && (
                  <div className="space-y-0.5 text-[9px]">
                    ...
                    {metrics.deviceStatus.metricsAvailable && <Progress value={metrics.deviceStatus.cpu} className="h-1" />}
                    ...
                    {metrics.deviceStatus.metricsAvailable && <Progress value={(metrics.deviceStatus.ramUsedMb / Math.max(1, metrics.deviceStatus.ramTotalMb)) * 100} className="h-1" />}
