...
export const SOUL_MESH_CORE_CAPABILITIES: Record<SoulNucleus, SoulMeshCapability[]> = {
  N01: [
    ...
    { id: 'neural.clareira.status', version: '1.0', description: 'Observed ProjetoClareira runtime status and metrics', request: true, response: true, events: false, owner: 'N01', execution: 'observability' },
    { id: 'neural.clareira.stimulus', version: '1.0', description: 'Inject a validated stimulus into the running ProjetoClareira graph', request: true, response: true, events: true, owner: 'N01', execution: 'native' },
    { id: 'neural.clareira.decision', version: '1.0', description: 'Request a decision from the ProjetoClareira root node', request: true, response: true, events: false, owner: 'N01', execution: 'cognitive' },
  ],
